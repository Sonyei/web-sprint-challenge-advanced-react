...
4. Define stateful logic.
  ...
  <!-- Stateful logic pertains to non-visual business logic, the goings-on behind the scene that make the app interactive, update, and re-render. (Although the logic behind actual visual elements, such as JSX involving CSS, is still considered stateful in the right context.) -->
...
Nothing needs to be done here. You _will_ have to navigate to the cart page in your app so you can go to the checkout form for the next step. x 
